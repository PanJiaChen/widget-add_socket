...
(function($) {
    ...
    var SchoolBox = (function() {
        ...
        var $schoolBoxCopy = $(
            ...
            '<div class="inline-block">选择学校</div>' +
            '</div>' +
        ...
        var $searchSchoolCopy = $(
            ...
            '<span class="text-error">找不到该学校</span><br>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '</div>');
        ...
        var init = function(instance) {
            ...
            // 初始化学校
            // NOTE: 这里不能用$el来find（否则on click将失效）
            ...
            $schoolDiv.find('a').on('click', function(event) {
                // 配置里定义的事件回调
        ...
        var initSearchSchool = function(instance) {
            ...
            $searchList.find('li').on('mouseenter', function() {
            ...
            // 选定学校
            $searchList.find('li').on('click', function() {
                // 配置里定义的事件回调
                if (instance.opts.schoolClickCallback) {
                    instance.opts.schoolClickCallback.apply(this, []);
                }
